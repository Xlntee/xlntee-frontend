...
import { Button, Typography, Stack, useTheme, FormLabel, TextField } from "@mui/material";
...
const AccountVerificationForm: FC<PageProps> = ({ title }) => {
  useTitle(title);
  ...
  return (
    <Stack gap="20px" className="account-verification-form">
      ...
      <Typography variant="body2" textAlign="left" className="account-verification-form__question">
      ...
      <FormLabel className="field-box">
        <Typography className="field-box__title">{t("account-verification.label")}</Typography>
        <TextField
          fullWidth
          name="verification-code"
          aria-label="verification-code input"
          placeholder={t("account-verification.placeholder")}
        />
      </FormLabel>
