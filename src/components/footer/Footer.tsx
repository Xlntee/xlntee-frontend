  ...
  return (
    <div className="footer">
      ...
      <div className="footer__about-block">
        <h2>Youni</h2>
        <p>
          Youni.com - Перша українська платформа онлайн освіти, яка допомагає
          створювати якісні онлайн курси різних напрямків та рівнів. Отримувати
          професійні знання від провірених лекторів та викладачів.
        </p>
